                ...
                <div>
                    <div className='flex items-center justify-between service1 py-8 px-12 rounded-full mb-6'>
                        ...
                        <div className='flex flex-col gap-3 w-[70%]'>
                            ...
                            <Link to={"/login"} className='bg-[#ed4747] w-fit px-7 py-2 rounded-md font-bold text-[#F7FFF7] border-2 border-[#ed4747] hover:border-2 hover:bg-transparent hover:border-[#ed4747] transition ease-in-out delay-50 text-lg hover:text-[#0e2b45]'>
                                Learn More
                            </Link>
                        </div>
                    </div>
