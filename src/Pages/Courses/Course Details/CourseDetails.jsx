    ...
    <div className='w-[90%] mx-auto py-8'>
      ...
      <div className='flex flex-col lg:flex-row gap-8'>
        <div className='w-full lg:w-[40%]'>
          <img
            className='w-full h-[350px] object-cover border-8 border-[#ed4747] rounded-md'
            src={imageUrl}
            alt=''
          />
        </div>
        ...
        <div className='space-y-2 w-full lg:w-[60%]'>
          ...
          <h2 className='text-2xl font-semibold text-[#0e2b45]'>
            {university_name}
          </h2>
          <div className='flex gap-3'>
            <h3 className='text-xl font-semibold text-[#ed4747] bg-[#ed474736] p-1'>
              {' '}
              Program ID: {_id}
            </h3>
            <h3 className='text-xl font-semibold text-[#ed4747] bg-[#ed474736] p-1'>
              {' '}
              Scholarship:{' '}
              {available_scholarship === 'yes' ? 'Available' : 'Unavailable'}
            </h3>
          </div>
          <h2 className='text-2xl font-bold text-[#0e2b45]'>
            Tuition Fee:
            {available_scholarship === 'yes' ? (
              <span className='space-x-2 flex flex-col md:flex-row space-y-3 md:space-y-0'>
                ...
                <span className='line-through'>{tuition_fees}$/Semester</span>
              </span>
            ) : (
              <span className='text-4xl text-[#ed4747] ml-2'>
          ...
          <div className='bg-[#ed474736] rounded-md p-6 space-y-4'>
            <div className='grid grid-cols-3'>
              ...
              <h3 className='text-base font-semibold text-[#0e2b45]'>
                ...
                {intakeTimeToDisplay(intake_time)}
              </h3>
            </div>
            <div className='grid grid-cols-3'>
      ...
      <div className='bg-[#F7FFF7] mt-6 py-4 px-0 md:px-6'>
        <h1 className='text-[#0e2b45] text-3xl font-bold pb-4 lg:pb-0'>
          Program Details
        </h1>
        <div>
          <h2 className='text-[#0e2b45] text-2xl text-center font-bold'>
            Basic Information
          </h2>
          <table className='w-full my-6'>
            <tr className='w-full border border-gray-300'>
              <td className='w-[40%] border border-gray-300 p-2 px-4 md:px-8 text-lg font-bold text-[#0e2b45] bg-[#ed474736]'>
                Course Name
              </td>
              <td className='w-[60%] border border-gray-300 p-2 px-4 md:px-8 text-lg font-bold text-[#0e2b45]'>
                <span className='capitalize'>{degree_name}</span> in{' '}
                {course_name}
              </td>
            </tr>
            ...
            <tr className='w-full border border-gray-300'>
              ...
              <td className='w-[60%] border border-gray-300 p-2 px-4 md:px-8 text-lg font-bold text-[#0e2b45] capitalize'>
                {field_name}
              </td>
            </tr>
            ...
            <tr className='w-full border border-gray-300'>
              <td className='w-[40%] border border-gray-300 p-2 px-4 md:px-8 text-lg font-bold text-[#0e2b45] bg-[#ed474736] capitalize'>
                Country
              </td>
              <td className='w-[60%] border border-gray-300 p-2 px-4 md:px-8 text-lg font-bold text-[#0e2b45] capitalize'>
                {country_name}
        ...
        <div className='mt-6'>
          ...
          <table className='w-full my-6'>
            <tr className='w-full border border-gray-300'>
              ...
              <td className='w-[60%] border border-gray-300 p-2 px-4 md:px-8 text-lg font-bold text-[#0e2b45]'>
                {tuition_fees} Dollars
              </td>
            </tr>

            <tr className='w-full border border-gray-300'>
              <td className='w-[40%] border border-gray-300 p-2 px-4 md:px-8 text-lg font-bold text-[#0e2b45] bg-[#ed474736]'>
                Scholarship Availibility
              </td>
              <td className='w-[60%] border border-gray-300 p-2 px-4 md:px-8 text-lg font-bold text-[#0e2b45] capitalize'>
                {available_scholarship}
              </td>
            ...
            <tr className='w-full border border-gray-300'>
              ...
              <td className='w-[60%] border border-gray-300 p-2 px-4 md:px-8 text-lg font-bold text-[#0e2b45]'>
                {scholarship_amount > 0 ? scholarship_amount : 0} Dollars
              </td>
            </tr>
            ...
            <tr className='w-full border border-gray-300'>
              ...
              <td className='w-[60%] border border-gray-300 p-2 px-4 md:px-8 text-lg font-bold text-[#0e2b45]'>
                {tuition_fees - scholarship_amount} Dollars
              </td>
            </tr>
        ...
        <div className='mt-6'>
          ...
          <table className='w-full my-6'>
            <tr className='w-full border border-gray-300'>
              <td
                className='w-[40%] border border-gray-300 p-2 px-4 md:px-8 text-lg font-bold text-[#0e2b45] bg-[#ed474736]'
                rowSpan={11}
              >
                Documents Required
              </td>
